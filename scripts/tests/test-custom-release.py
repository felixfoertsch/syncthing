...
'''
    ...
    def test_manual_tag_and_suffix_are_resolved_once(self):
        self.env.update(CUSTOM_RELEASE_UPSTREAM_TAG='v2.1.4', CUSTOM_RELEASE_SUFFIX='stignore.8')
        self.preflight()
        self.assertIn('tag=v2.1.4-stignore.8', (self.base / 'output').read_text())
